...
export default function GiftOrnek() {
  return (
    <div className="min-h-dvh px-5 pb-24 pt-4 lg:mx-auto lg:max-w-3xl lg:px-0 lg:pb-16 lg:pt-10" style={{ background: "#0E0D10" }}>
      <header className="mb-5 flex items-center gap-3 lg:mb-8">
        ...
        <h1 className="font-display text-lg font-bold lg:text-2xl">Animasyonlu hediye — örnek</h1>
      </header>

      <DiamondGift size={300} />

      <div className="lp-panel mt-5 rounded-2xl p-4 lg:mt-6 lg:p-6">
        <p className="mb-1 font-display font-semibold text-text lg:text-lg">Bu tamamen kod (SVG + Framer Motion)</p>
        <p className="text-sm text-muted lg:text-base lg:leading-relaxed">
