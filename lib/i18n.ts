...
// Pazarlama sözlüğünün landing'de görünen alanları (header nav + footer başlıkları)
// ar/fa için çevrildi; landing dışında kalan alanlar İngilizce tabanından gelir.
// (Landing'in asıl içeriği APP_DICT.landing'den; bkz. aşağısı.)
const arDict: Dict = {
  ...en,
  nav: { ...en.nav, safety: "الأمان", about: "حول", download: "تنزيل" },
  footer: { ...en.footer, rights: "جميع الحقوق محفوظة.", product: "المنتج", company: "الشركة", legal: "قانوني", privacy: "الخصوصية", terms: "الشروط", kvkk: "KVKK" },
};
const faDict: Dict = {
  ...en,
  nav: { ...en.nav, safety: "امنیت", about: "درباره", download: "دانلود" },
  footer: { ...en.footer, rights: "همه‌ی حقوق محفوظ است.", product: "محصول", company: "شرکت", legal: "حقوقی", privacy: "حریم خصوصی", terms: "شرایط", kvkk: "KVKK" },
};
const DICT: Record<Lang, Dict> = { tr, en, ku, ar: arDict, fa: faDict };
...
const arOverride: DeepPartial<AppDict> = {
  ...
  landing: {
    navKesfet: "اكتشف", navMoments: "لحظات", navPremium: "بريميوم", login: "تسجيل الدخول", join: "انضم إلى Ahenk",
    footerTagline: "الشخصية أولاً، الوجه لاحقاً. منصة اكتشاف اجتماعي مميّزة.",
    footerBottom: "منصة الاكتشاف الاجتماعي المميّزة في تركيا",
    badge: "تجربة الاكتشاف الاجتماعي المميّزة في تركيا",
    titleLine1: "الشخصية أولاً،", titleLine2: "الوجه لاحقاً.",
    subtitle: "يجمع Ahenk بين الاكتشاف واللحظات والريلز وطاولات الألعاب الحيّة واقتصاد الهدايا المميّز في واجهة واحدة فاخرة وهادئة.",
    ctaJoin: "انضم إلى Ahenk", ctaExperience: "شاهد التجربة",
    trust1: "مجتمع موثّق +18", trust2: "خصوصية صورتك بيدك", trust3: "ملفات تتّضح مع المحادثة",
    features: [
      { title: "لغة تصميم مميّزة", text: "درجات داكنة، لمسة نحاسية مطفية وطباعة هادئة تمنح تجربة فاخرة ونظيفة وموثوقة." },
      { title: "الشخصية أولاً", text: "الشخصية تأتي قبل الصورة؛ يتّضح الملف كلما تعمّقت المحادثة. فضول لا حكم مسبق." },
      { title: "حيّ وتفاعلي", text: "اللحظات والقصص والريلز والطاولات الصوتية والتفاعل الاجتماعي تجتمع في منتج واحد." },
      { title: "تجربة هدايا فاخرة", text: "كل هدية بتصميم خاص ورسوم سينمائية وإحساس بالتميّز." },
      { title: "الثقة والجودة", text: "التوثيق والشارات وسجلّات الخصوصية والميزات المميّزة تبني مجتمعاً آمناً." },
    ],
    prodEyebrow: "بنية المنتج", prodTitle: "ليست مواعدة عادية، بل عالم اجتماعي حيّ.",
    prodDesc: "كل وحدة مرتبطة بنظام التصميم نفسه: سطح أونيكس، لمسة نحاسية، تسلسل واضح ومساحات مميّزة.",
    products: [
      { k: "اكتشف", t: "الشخصية أولاً، الوجه لاحقاً", d: "نظام اكتشاف يقدّم الشخصية لا الصورة؛ تدفّق كشف آمن كلما تقدّمت المحادثة." },
      { k: "لحظات", t: "قوة المحتوى والطاقة الاجتماعية", d: "مع القصص واللحظات والريلز لا يكتفي المستخدم بالتمرير؛ بل يعبّر عن نفسه." },
      { k: "تجربة حيّة", t: "صوت وفيديو وطاولات 101", d: "مكالمات WebRTC وطاولات ألعاب صوتية ومساحات اجتماعية حيّة تجتمع بإحساس مميّز." },
      { k: "الأمان", t: "مجتمع متوافق مع الخصوصية ومُدار", d: "الخصوصية والإبلاغ والحظر والتوثيق ومراجعة الرسائل المُدارة في خطّ واحد." },
    ],
    premiumTitle: "إحساس البريميوم يبدأ من الشاشة الأولى.",
    premiumDesc: "من الدخول إلى المتجر، ومن الملف إلى الرسالة، يعمل كل التدفّق بلغة العلامة نفسها: ألوان قليلة، تباين قوي، مساحات جيدة وحركة أنيقة.",
    ctaStart: "ابدأ الآن", ctaSafety: "معيار الأمان",
    badges: ["التوثيق", "بريميوم", "الهدايا", "المجتمع", "ريلز", "الخصوصية"], badgeSub: "معيار Ahenk",
    mDiscover: "اكتشف", mMoments: "لحظات", mGiftStore: "متجر الهدايا",
    chipsDiscover: ["الكل", "بالقرب منك", "متصل", "جديد", "شائع"], chipsGift: ["الكل", "شائع", "فاخر", "خاص", "فعالية"],
    mNewMember: "عضو جديد", mOnline: "متصل", mBuyTokens: "شراء جيتون", mBuyTokensDesc: "اكتشف الباقات المميّزة",
    mYourMoment: "لحظتك", mCaption: "سكينة غروب الشمس", mAgo: "قبل ساعتين · إسطنبول",
  },
  settings: {
    title: "الإعدادات",
...
const faOverride: DeepPartial<AppDict> = {
  ...
  landing: {
    navKesfet: "کشف", navMoments: "لحظه‌ها", navPremium: "پریمیوم", login: "ورود", join: "به Ahenk بپیوند",
    footerTagline: "اول شخصیت، بعد چهره. پلتفرم کشف اجتماعی ویژه.",
    footerBottom: "پلتفرم کشف اجتماعی ویژه‌ی ترکیه",
    badge: "تجربه‌ی کشف اجتماعی ویژه‌ی ترکیه",
    titleLine1: "اول شخصیت،", titleLine2: "بعد چهره.",
    subtitle: "Ahenk کشف، لحظه‌ها، ریلز، میزهای بازی زنده و اقتصاد هدیه‌ی ویژه را در یک رابط آرام و لوکس گرد هم می‌آورد.",
    ctaJoin: "به Ahenk بپیوند", ctaExperience: "تجربه را ببین",
    trust1: "جامعه‌ی تأییدشده‌ی +۱۸", trust2: "حریم عکس در دست توست", trust3: "نمایه‌هایی که با گفتگو روشن می‌شوند",
    features: [
      { title: "زبان طراحی ویژه", text: "تن‌های تیره، تأکید برنجی مات و تایپوگرافی آرام، تجربه‌ای گران، تمیز و قابل‌اعتماد می‌سازد." },
      { title: "اول شخصیت", text: "شخصیت پیش از عکس می‌آید؛ نمایه با عمیق‌شدن گفتگو روشن می‌شود. کنجکاوی، نه پیش‌داوری." },
      { title: "زنده و تعاملی", text: "لحظه‌ها، استوری‌ها، ریلز، میزهای صوتی و تعامل اجتماعی در یک محصول جمع می‌شوند." },
      { title: "تجربه‌ی هدیه‌ی لوکس", text: "هر هدیه طراحی خاص، انیمیشن سینمایی و حس تمایز دارد." },
      { title: "اعتماد و کیفیت", text: "تأیید، نشان‌ها، سوابق حریم خصوصی و ویژگی‌های ویژه جامعه‌ای امن می‌سازند." },
    ],
    prodEyebrow: "معماری محصول", prodTitle: "دوستیابی معمولی نیست، یک دنیای اجتماعی زنده است.",
    prodDesc: "هر ماژول به یک سیستم طراحی متصل است: سطح اونیکس، تأکید برنجی، سلسله‌مراتب روشن و فضای ویژه.",
    products: [
      { k: "کشف", t: "اول شخصیت، بعد چهره", d: "سیستم کشفی که شخصیت را پیش می‌گذارد نه عکس؛ جریان آشکارسازی امن با پیشرفت گفتگو." },
      { k: "لحظه‌ها", t: "قدرت محتوا و انرژی اجتماعی", d: "با استوری، لحظه‌ها و ریلز کاربر فقط اسکرول نمی‌کند؛ خودش را بیان می‌کند." },
      { k: "تجربه‌ی زنده", t: "صدا، تصویر و میزهای ۱۰۱", d: "تماس‌های WebRTC، میزهای بازی صوتی و فضاهای اجتماعی زنده با حسی ویژه ترکیب می‌شوند." },
      { k: "امنیت", t: "جامعه‌ی سازگار با حریم خصوصی و مدیریت‌شده", d: "حریم خصوصی، گزارش، مسدودسازی، تأیید و بازبینی مدیریت‌شده‌ی پیام در یک خط." },
    ],
    premiumTitle: "حس پریمیوم از همان صفحه‌ی نخست آغاز می‌شود.",
    premiumDesc: "از ورود تا فروشگاه، از نمایه تا پیام، کل جریان با همان زبان برند کار می‌کند: رنگ کم، کنتراست قوی، فضای خوب و حرکت ظریف.",
    ctaStart: "همین حالا شروع کن", ctaSafety: "استاندارد امنیت",
    badges: ["تأیید", "پریمیوم", "هدایا", "جامعه", "ریلز", "حریم خصوصی"], badgeSub: "استاندارد Ahenk",
    mDiscover: "کشف", mMoments: "لحظه‌ها", mGiftStore: "فروشگاه هدیه",
    chipsDiscover: ["همه", "نزدیک تو", "آنلاین", "جدید", "محبوب"], chipsGift: ["همه", "محبوب", "لوکس", "ویژه", "رویداد"],
    mNewMember: "عضو جدید", mOnline: "آنلاین", mBuyTokens: "خرید ژتون", mBuyTokensDesc: "بسته‌های ویژه را کشف کن",
    mYourMoment: "لحظه‌ی تو", mCaption: "آرامش غروب", mAgo: "۲ ساعت پیش · استانبول",
  },
  settings: {
    title: "تنظیمات",
