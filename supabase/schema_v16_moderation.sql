-- =====================================================================
--  AHENK — Şema v16 (MODERASYON: yasaklama / ban)
--  ADDITIVE + idempotent. profiles.banned + keşfetten dışlama.
--  Yasaklı kullanıcı: keşfette çıkmaz; (app) layout'ta /askida'ya yönlendirilir.
-- =====================================================================
...
-- discover_candidates: yasaklıları hariç tut (v8 gövdesi + tek koşul).
...
-- discover_count: aynı yasaklı filtresi.
